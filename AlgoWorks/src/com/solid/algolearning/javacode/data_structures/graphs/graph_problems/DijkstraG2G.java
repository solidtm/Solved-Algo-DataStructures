        ...
        for (int count = 0; count < vertices - 1; count++) {
           ...
           sptSet[u] = true;
            ...
            for (int v = 0; v < vertices; v++) {
                ...
                if(!sptSet[v] && graph[u][v] != 0   //if not in spSet and there is an edge btwn u-v
                        && dist[u] != Integer.MAX_VALUE  //
                        && dist[u] + graph[u][v] < dist[v]){ //and total weight of path frm src to v is < current value of v.
