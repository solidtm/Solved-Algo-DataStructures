...
public class ReverseAlternatinKElementSubList {
    ...
    public static ListNode reverse(ListNode head, int k) {
        ...
        while (current != null) { // break if we've reached the end of the list
            ListNode lastNodeOfPreviousPart = previous;// after reversing the LinkedList 'current' will become the last node of the sub-list
            ...
            else head = previous;   // this means we are changing the first node (head) of the LinkedList
