...
//        2. If, while moving backward, we reach the beginning of the array, we will jump to the last element to continue
//        the movement.
//
    ...
    public static boolean loopExists(int[] arr) {
        for (int i = 0; i < arr.length; i++) {
            ...
            do {
                ...
                if (fast != -1) fast = findNextIndex(arr, isForward, fast);// move another step for fast pointer
