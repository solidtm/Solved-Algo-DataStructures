...
//        after index middle as the array is sorted in the ascending order.
...
//        before index middle as the array is sorted in the ascending order.
//        Hence, we can reduce our search to start = mid + 1.
//        We will repeat steps 2-4 with new ranges of start to end. If at any time start becomes greater than end,
...
//        We can compare the numbers pointed out by start and end index to find the sort order. If arr[start] < arr[end],
