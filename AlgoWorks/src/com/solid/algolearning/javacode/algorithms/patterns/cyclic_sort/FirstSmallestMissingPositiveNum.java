...
//        and ignore all numbers that are out of the range of the array (i.e., all negative numbers and all numbers greater than or equal to the length of the array).
...
public class FirstSmallestMissingPositiveNum {
