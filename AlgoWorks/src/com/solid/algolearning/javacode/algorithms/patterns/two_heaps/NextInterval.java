...
//        the other on maximum end time (let’s call it maxEndHeap). We can then iterate through all
//        intervals of the maxEndHeap to find their next interval. Our algorithm will have the following steps:
//
//        Take out the top (having the highest end) interval from the maxEndHeap to find its next interval.
